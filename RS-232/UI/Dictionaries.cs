...
namespace UI
{
    public class SerialPortDictionaries
    {
        ...
        {
                  {Parity.Even, Parity.Even.ToString()},
                  {Parity.Mark, Parity.Mark.ToString()},
                  {Parity.None,Parity.None.ToString()},
                  {Parity.Odd,Parity.Odd.ToString()},
                  {Parity.Space,Parity.Space.ToString()}
        };
        public static Dictionary<Parity, string> ParityDictionary
        {
            get
            {
                return _parityDictionary;
            }
        }
        #endregion
        ...
        {
                  {StopBits.None, StopBits.None.ToString()},
                  {StopBits.One, StopBits.One.ToString()},
                  {StopBits.Two, StopBits.Two.ToString()},
        };
        public static Dictionary<StopBits, string> StopBitsDictionary
        {
            get
            {
                return _stopBitsDictionary;
            }
        }
        #endregion
        ...
        {
                  {Handshake.None, StopBits.None.ToString()},
                  ...
                  {Handshake.XOnXOff, Handshake.XOnXOff.ToString()}
        };
        public static Dictionary<Handshake, string> HandshakeDictionary
        {
            get
            {
                return _handshakeDictionary;
            }
        }
        #endregion
